              ...
              <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
                ...
                <SheetContent side="right" className={`w-80 ${isDarkMode ? 'bg-gray-900/95 border-gray-700' : 'bg-white/95 border-purple-100'}`}>
                  ...
                  <div className="mt-6 space-y-2">
                    <Button variant="ghost" className={`w-full justify-start ${activeTab === 'home' ? (isDarkMode ? 'bg-purple-900/50 text-purple-300' : 'bg-purple-100 text-purple-700') : (isDarkMode ? 'text-gray-300 hover:bg-gray-800' : 'text-gray-700 hover:bg-gray-100')}`} onClick={() => { setActiveTab('home'); setIsMenuOpen(false); }}><Home className="w-5 h-5 mr-3" />Inicio</Button>
                    ...
                    <Button variant="ghost" className={`w-full justify-start ${activeTab === 'team' ? (isDarkMode ? 'bg-purple-900/50 text-purple-300' : 'bg-purple-100 text-purple-700') : (isDarkMode ? 'text-gray-300 hover:bg-gray-800' : 'text-gray-700 hover:bg-gray-100')}`} onClick={() => { setActiveTab('team'); setIsMenuOpen(false); }}><Mail className="w-5 h-5 mr-3" />Contactar Equipo</Button>
